...
class SessionTracker:
    ...
    def format_terminal(self) -> str:
        ...
        cfs = self._compute_counterfactuals()
        if cfs:
            from ..ux.counterfactual import format_counterfactuals_terminal
    ...
    def _compute_counterfactuals(self) -> list:
        ...
        try:
            ...
            from ..ux.counterfactual import compute_counterfactuals
...
def check_health_nudges(
    ...
    if repo_root:
        try:
            from ..engine.discovery import find_resolution_scope_with_source
