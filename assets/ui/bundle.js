...
fn fs_edge_main(in: EdgeFragment) -> @location(0) vec4<f32> {
    ...
    if (in.is_source_sel == 0.0 && in.is_target_sel == 0.0) {
        return vec4<f32>(0.05, 0.1, 0.25, 0.08); // Mesmerizing very faint ambient space web
    }
