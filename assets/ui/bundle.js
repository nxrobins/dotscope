...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let center_dir = vec3<f32>(params.gravity_x, params.gravity_y, 0.0) - node.pos_mass.xyz;
